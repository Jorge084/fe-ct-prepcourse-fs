...
function incrementarPorUno(array) {
   ...
   for(var i=0;i <array.length;i++) {var incrMasuno= array[i]+1;
   incrementarPorUno.push(incrMasuno);}
...
function multiplicarArgumentos() {
   ...
   let producto=1;
   for(let i=0; i<arguments.length;i++){producto=arguments[i]*producto;}
   return producto;
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var todosElementos= array.filter((mayor)=> mayor>18);
...
function diaDeLaSemana(numeroDeDia) {
   ...
   else (numeroDeDia===6||numeroDeDia===1); return "Es fin de semana";
}
...
function tablaDelSeis() {
   ...
   let res=arr.map(function(elem){return elem*6;})
   return res;
}
